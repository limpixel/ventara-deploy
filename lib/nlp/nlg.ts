...
const TEMP_SANGAT_PANAS: Array<(a: TemplateArgs) => string> = [
  ...
  (a) => `${a.tempC?.toFixed(0)}°C bisa memaksa tubuh bekerja keras. Lindungi kepala dan perbanyak minum.`,
...
export function generateNlg(
  ...
  const keyPhrase = buildKeyPhrase(analysis.features.topTerms, stemmed.concepts, analysis.reasoning.derivedInsights)
