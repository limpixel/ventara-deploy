...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-slate-300 bg-white/95 backdrop-blur-sm [&>button:not(:last-child)]:border-slate-200 flex flex-col overflow-hidden rounded-md border shadow-lg [&>button:not(:last-child)]:border-b">
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex size-8 items-center justify-center transition-all text-slate-600",
        "first:rounded-t-md last:rounded-b-md",
        "hover:bg-slate-100 dark:hover:bg-accent/40",
