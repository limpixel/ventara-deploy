...
export default function RegisterForm({ onRegister, onSwitch }: Props) {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-[linear-gradient(135deg,#163832_0%,#1f4d45_28%,#2d6a5f_58%,#3f8f7f_100%)] flex justify-center items-center p-4 px-14">
      ...
      >
        ...
        >
          <span className="block text-[60px] -mb-4">Create Account</span>
        </h1>
        <p
          className={`
         ${poppins.className}text-sm text-white/65 mb-10`}
        >
          Join Ventara and explore future insights with us.
        </p>
        ...
        <button
          type="submit"
          className="group relative px-37.5 py-3.5 ml-6 rounded-xl bg-white text-[#163832] font-semibold text-sm overflow-hidden transition-all duration-300 hover:scale-[1.01] hover:bg-[#f4fffb] active:scale-[0.98] shadow-[0_10px_30px_rgba(255,255,255,0.12)]"
        >
          <span className="relative z-10 inline-block px-20">Sign Up</span>
        ...
        <div className="mt-8 text-center space-y-2">
          <p className="text-[13px] leading-relaxed text-white/80">
            ...
            <button className="text-white underline hover:no-underline underline-offset-2 transition">
              Terms of Use
            </button>{" "}
            &{" "}
            <button className="text-white underline hover:no-underline underline-offset-2 transition">
          ...
          <p className="text-[13px] leading-relaxed text-white/80 max-w-sm mx-auto">
