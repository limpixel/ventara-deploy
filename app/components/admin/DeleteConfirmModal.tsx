...
export const DeleteConfirmModal = ({ isOpen, username, onConfirm, onCancel }: DeleteConfirmModalProps) => {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-9999 animate-fadeIn">
      <div className="bg-white rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl transform animate-scaleIn">
        ...
        <div className="flex gap-3">
          ...
          <button 
            onClick={onConfirm} 
            className="flex-1 px-4 py-2.5 rounded-xl bg-linear-to-r from-red-500 to-rose-500 text-white font-medium hover:shadow-lg hover:shadow-red-500/25 transition-all"
          >
            Nonaktifkan
          </button>
        </div>
