  ...
  return (
    <div className={`rounded-xl border p-4 ${color.bg} ${color.border}`}>
      ...
      <div className="relative h-12 flex items-center mb-3">
        ...
        {/* Box IQR */}
        <div
          className={`absolute h-6 rounded border-2 ${color.border}`}
          style={{
            left: pct(q1),
        ...
        {/* Median line */}
        <div
          className="absolute w-0.5 h-6 z-10"
          style={{ left: pct(median), backgroundColor: color.line }}
        />

        {/* Mean dot */}
        <div
          className="absolute w-2 h-2 rounded-full z-10 -translate-x-1"
      ...
      <div className="grid grid-cols-3 gap-1 text-xs text-gray-500">
        <span>
          Min: <b className="text-gray-700">{min}</b>
        </span>
        <span className="text-center">
          Median: <b className="text-gray-700">{median}</b>
        </span>
        <span className="text-right">
          Max: <b className="text-gray-700">{max}</b>
        </span>
        <span>
          Q1≈ <b className="text-gray-700">{q1.toFixed(2)}</b>
        </span>
        <span className="text-center">
          Mean: <b className="text-gray-700">{mean}</b>
        </span>
        <span className="text-right">
          Q3≈ <b className="text-gray-700">{q3.toFixed(2)}</b>
        </span>
      </div>
    </div>
  );
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm text-gray-400">
            -- Statistik deskriptif dataset aktif
          </p>
        </div>
